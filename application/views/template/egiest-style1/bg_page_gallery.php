...
<div id="main" class="clr3">
  <div class="container" style="background:#fff;">
    <div class="row">
      <div class="col-md-12" style="border-right:1px #ecf0f1 solid;">
        <ol class="breadcrumb" style="margin:20px 0;">
            <li><a href="#">Home</a></li>
            <li class="active">News</li>
        </ol> 
        <h2 style="border-bottom:1px #ecf0f1 solid;padding-bottom:10px;margin-top:15px;">Gallery</h2>
        <div class="row">         
          ...
          <div class="col-md-3" style="margin-bottom:20px;text-align:center;">             
            <img class="img-responsive" src="<?php echo base_url(); ?>assets/img/p2.jpg"> 
             <h4><a href="#">Lorem Ipsum</a></h4>                         
          </div> 
         <div class="col-md-3" style="margin-bottom:20px;text-align:center;">             
            <img class="img-responsive" src="<?php echo base_url(); ?>assets/img/p3.jpg">
             <h4><a href="#">Lorem Ipsum</a></h4>                          
          </div> 
          <div class="col-md-3" style="margin-bottom:20px;text-align:center;">             
            <img class="img-responsive" src="<?php echo base_url(); ?>assets/img/p1.jpg">
